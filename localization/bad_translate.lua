return {
    descriptions={
        ...
        Joker={
            ...
            j_bloodstone={
                name="Bloodstone looks like this",
                text={
                    "Play a {C:hearts}heart{} card or two",
                    "for a chance to win",
                    "{X:mult,C:white} x#3# {} multi.",
                },
                unlock={
                    "The entire set requires",
                    "at least {C:attention,E:1}#1# {C:hearts,E:1}heart{} cards."
                },
            },
            j_blue_joker={
                name="like that blue clown",
                text={
                    "{C:chips}+#1#{} Tokens for each",
                    "remaining card in the {C:attention}deck",
                    "{C:inactive}(currently {C:chips}+#2#{C:inactive} Tokens)",
                },
            },
            j_blueprint={
                name="This is a diagram",
                text={
                    "He has officially restored",
                    "the {C:attention}Joker{}'s powerss",
                },
                unlock={
            ...
            j_bootstraps={
                name="bootstrap does this",
                text={
                    "{C:mult}+#1#{} multiplier required",
                    "for every {C:money}$#2#{}",
                    "{C:inactive}(Currently {C:mult}+#3#{C:inactive} multiplier){}.",
                },
                unlock={
                    "People who own clowns","of two or more colors"
                },
            },
            j_brainstorm={
                ...
                text={
                    ...
                    "left-wing {C:attention}clown{}'s skills.",
                },
                unlock={
                    "People who like",
                    "{E:1,C:attention}royal giveaways",
                },
            },
            j_bull={
                name="Love this sticker",
                text={
                    "It costs{C:chips}#1#{} tips",
                    "per {C:money}dollar{}",
                    "{C:inactive}(Currently {C:chips}#2#{C:inactive} tips){}.",
                },
            },
            j_burglar={
            ...
            j_burnt={
                name="A burning clown",
                text={
                    "This improves the quality",
                    "of the first {C:attention}poker hand",
                    "each round.",
                },
                unlock={
                    "A total of {E:1,C:attention}#1#{} tickets",
                    "were sold by approximately",
                    "#2# people.",
                },
            },
            j_business={
                name="This is what the business card looks like",
                text={
                    "The {C:attention}face{} card game",
                    "has {C:green}#2#-#1#{} odds to",
                    "pay {C:money}$2{}.",
                },
            },
            j_caino={
            ...
            j_campfire={
                name="I love this camp",
                text={
                    "After a {C:attention}blind{} win,",
                    "Joker will receive {X:mult,C:white}X#1#x{}",
                    "{C:inactive}(Currently {X:mult,C:white}X#2#x{C:inactive})",
                    "for each ticket {C:attention}sold{}.",
                },
            },
            j_card_sharp={
                name="Such a sharp card",
                text={
                    "If this {C:attention}hand{} has already",
                    "been played one turn",
                    "it is Toon {X:mult,C:white}X#1#{}."
                },
            },
            j_cartomancer={
                name="like this iconic magician",
                text={
                    "When choosing {C:attention}blinds{},",
                    "create {C:tarot}tarot{} cards",
            ...
            j_cavendish={
                name="Like Cavendish",
                text={
                    "{X:mult,C:white} X#1# {} multi has a",
            ...
            j_ceremonial={
                name="like a ceremonial dagger",
                text={
                    "After installing the {C:attention}veil{},",
                    "turn off the right Joker",
                    "and add {C:attention}double{} to the {C:mult}trick",
                    "{C:inactive}(currently {C:mult}+#1#{C:inactive} Molt)",
                },
            },
            j_certificate={
                ...
                text={
                    ...
                    "a random {C:attention}playing",
                    "{C:attention}card{} of a random",
                    "{C:attention}suit{} is added",
                    "to your hand",
                },
                unlock={
                    "Gold cards with",
            ...
            j_chaos={
                name="like a wild clown",
                text={
                    "For example,",
                    "{C:attention}#1#{} free {C:green}return",
                    "per store",
                },
            },
            j_chicot={
            ...
            j_clever={
                name="That clever clown",
                text={
                    "{C:chips}+#1#{} points if",
                    "there are {C:attention}2 pairs{}.",
                },
            },
            j_cloud_9={
                name="Like cloud 9",
                text={
                    "At the end of round",
                    "you will receive {C:money}$#1#",
                    "for every {C:attention}9{} cards",
                    "in your {C:attention}entire deck",
                    "{C:inactive}(Currently {C:money}$#2#{}{C:inactive}){}.",
                },
            },
            j_constellation={
                name="It's like a horoscope",
                text={
                    "This wild card receives",
                    "a multiplier of {X:mult,C:white} X#1# {}",
                    "{C:inactive}(now a multiplier of {X:mult,C:white}X#2#{C:inactive})",
                    "when a {C:planet}star{} card is played.",
                },
            },
            j_crafty={
                name="that sly clown",
            ...
            j_credit_card={
                name="This is a credit card",
                text={
                    "Credit up to {C:red}$#1#{}",
                },
            },
            j_delayed_grat={
            ...
            j_gift={
                name="The gift card looks like this...",
                text={
                    "At the end of round, each",
                    "{C:attention}Joker{} and {C:attention}spending{}",
                    "card will be sold for",
                    "an additional {C:money}$#1#{}"
                },
            },
            j_glass={
                name="joke with the bottle",
                text={
                    "The wild symbol gains a",
                ...
                unlock={
                    ...
                    "at least {E:1,C:attention}#1# glass cards{}.",
                },
            },
            j_gluttenous_joker={
                name="This clown is too greedy",
                text={
                    "Cards played in the",
                    "{C:clubs}club{} deck provide",
                    "{C:mult}+#1#{} to multiplayer play.",
                },
            },
            j_golden={
                name="Like this golden clown",
                text={
            ...
            j_greedy_joker={
                name="That greedy clown",
                text={
                    "multiplicity {C:mult}+#1#{} when",
                    "playing {C:diamonds}diamond{}",
                    "pattern cards."
                },
            },
            j_green_joker={
                name="green clown",
                text={
                    "For plays played, this",
                    "means {C:mult}+#1#{} bonus token;",
                    "For stacked hands, this",
                    "means {C:mult}-#2#{} extra chip",
                    "{C:inactive}(currently {C:mult}+#3#{C:inactive} extra chip){}.",
                },
            },
            j_gros_michel={
                name="Like Gross Michel",
                text={
                    "This comic card has",
                    "a {C:mult}+#1#{} chance to",
                    "to destroy this card",
                    "at the end of its turn.",
                },
            },
            j_hack={
                name="Hackers of this kind",
                text={
                    "This card plays",
                    "the numbers",
            ...
            j_half={
                name="Looks like a half clown",
                text={
                    "{C:red}+#1#{} multi if you have",
            ...
            j_hallucination={
                name="it's a fantasy",
                text={
                    "Unlocking {C:attention}boosters",
                    "gives you a {C:green}#1# in #2#{}",
                    "chance to create",
                    "a {C:tarot}Tarot{} deck",
                    "{C:inactive}(requires space)"
                },
            },
            j_hanging_chad={
                ...
                text={
                    "Retrigger has already run",
                    "the scorecards {C:attention}twice{}.",
                    "example:",
                },
                unlock={
                    "When you defeat",
                    "the blind boss",
                    "with {E:1,C:attention}high cards{},",
                },
            },
            j_hiker={
                name="travelers love it",
                text={
                    "If you win, each",
                    "played {C:attention}card{}",
                    "regularly is worth",
                    "{C:chips}+#1#{} points.",
                },
            },
            j_hit_the_road={
                name="How to get on the road",
                text={
                    "For each {C:attention}Jack{}",
                    "rolled this round,",
                    "The joker receives a",
                    "multiplier of {X:mult,C:white}X#1#{}",
                    "{C:inactive}(currently the multiplier is {X:mult,C:white} X#2# {C:inactive}){}.",
                },
                unlock={
                    "Compress {E:1,C:attention}5",
                    "{E:1,C:attention}nozzles{} at once",
                },
            },
            j_hologram={
                name="It's like a 3D image",
                text={
                    "Each time a {C:attention}playing card{}",
                    "is added to the deck,",
                    "the Joker receives a",
                    "{X:mult,C:white} X#1# {} multiplier",
                    "{C:inactive}(currently an {X:mult,C:white} X#2# {C:inactive} multiplier){}.",
                },
            },
            j_ice_cream={
                name="Just like ice cream",
                text={
                    "This means {C:chips}+#1#{} Chips",
            ...
            j_invisible={
                name="This invisible clown",
                text={
                    "After {C:attention}#1#{} turns,",
                    "sell this card and",
                    "{C:attention}copy{} a random joke",
                    "{C:inactive}(currently {C:attention}#2#{C:inactive}/#1#){}.",
                },
                unlock={
                    "Win a round with",
                    "{E:1,C:attention}4{} or less {E:1,C:attention}wild symbols{}.",
                },
            },
            j_joker={
                name="This is interesting",
                text={
                    "It is equal to {C:red,s:1.1}+#1#{}",
                },
            },
            j_jolly={
            ...
            j_mad={
                name="This is a crazy clown",
                text={
                    "{C:red}+#1#{} if you play",
                    "two {C:attention}multiplayer combos",
                },
            },
            j_madness={
                name="so crazy",
                text={
                    "Choosing {C:attention}small{} or {C:attention}big blinds{} will",
                    "give you a multiplier of {X:mult,C:white} x#1# {}",
                    "to {C:attention}get rid of{} random clowns",
                    "{C:inactive}(currently the multiplier is {X:mult,C:white} x#2# {C:inactive}){}.",
                },
            },
            j_mail={
            ...
            j_marble={
                name="this marble clown",
                text={
                    "If a {C:attention}blind{} card is chosen,",
                    "a {C:attention}stone{} card is added",
                    "to the deck."
                },
            },
            j_matador={
                name="Like this matador",
                text={
                    "If the hand is played",
                    "and you win {C:money}$#1#{}, the",
                    "{C:attention}boss{}'s starting ability",
                    "is activated"
                },
                unlock={
                    "Fight bosses blindly",
                    "with {E:1,C:attention}one hand{} without",
                    "using reset.",
                },
            },
            j_merry_andy={
                ...
                unlock={
                    "He pitched {E:1,C:attention}#1#{} innings",
                    "and allowed one run.",
                },
            },
            j_midas_mask={
                name="This is the Midas mask",
                text={
                    "When hit, all cards played",
                    "turn into {C:attention}gold{} coins.",
                },
            },
            j_mime={
                name="This is imitation",
                text={
                    "Repeat all",
                    "cards {C:attention}in your",
                    "{C:attention}hand{} as a skill.",
                },
            },
            j_misprint={
                name="this is a typo",
            ...
            j_mr_bones={
                name="Just like the Bone Master",
                text={
                    "Prevents death",
                    "and can {C:red,E:2}self-destruct",
                    "if discarded chips",
                    "account for at least",
                    "{C:attention}25%{} of the chips needed.",
                },
                unlock={
                    "Conceived {C:attention,E:1}#1#{} goals",
                    "{C:inactive}(#2#){}.",
                },
            },
            j_mystic_summit={
                name="Like a mysterious mountain",
                text={
                    "If we ignore the",
                    "remaining zeros,",
                    "the reading of the",
                    "multimeter will be {C:mult}+#1#{}."
                },
            },
            j_obelisk={
                name="Looks like an obelisk",
                text={
                    "In poker, the Joker receives",
                    "a multiplier of {X:mult,C:white} X#1# {}",
                    "{C:inactive}(now a multiplier of {X:mult,C:white} X#2# {C:inactive})",
                    "on every {C:attention}consecutive{} hand except",
                    "for the most played {C:attention}hand{}.",
                },
            },
            j_odd_todd={
                name="Because foreigners want it",
                text={
                    "One card gives",
                    "{C:chips}+#1#{} points",
            ...
            j_onyx_agate={
                ...
                text={
                    "Cards played in the",
                    "{C:clubs}club{} will receive",
                    "a {C:mult}+#1#{} multiplier.",
                },
                unlock={
                    "There are at least {E:1,C:attention}#1#",
                    "{E:1,C:attention}club{} cards in the deck.",
                },
            },
            j_oops={
                name="Wow! Only 6 likes",
                text={
                    "This doubles all of the",
                    "{C:attention}above {C:green,E:1,S:1.1}options",
                    "{C:inactive}(eg {C:green}1 of 3{C:inactive} -> {C:green}2 of 3{C:inactive}){}.",
                },
                unlock={
                    "Purchase a minimum",
                    "of {E:1,C:attention}#1#{} chips",
                    "per set.",
                },
            },
            j_order={
                name="Because as a team",
                text={
                    "Which is included in",
                    "the {C:attention}cartoon and gameplay",
                    "aspects of {X:mult,C:white} X#1# {}"
                },
                unlock={
                    "Victory without",
                    "a {E:1,C:attention}straight line",
                },
            },
            j_pareidolia={
                name="It's a utopian fantasy",
                text={
                    "All tickets are",
                    "considered {C:attention}free{}.",
                },
            },
            j_perkeo={
                name="Like PerK.",
                text={
                    "This creates a {C:dark_edition}Negative{} copy",
                    "of the last {C:attention}store's{}",
                    "random {C:attention}expense{} card.",
                },
                unlock={
                    "{E:1,s:1.3}What? ? ? ? ? How",
                },
            ...
            j_photograph={
                name="oh i love taking pictures",
                text={
                    "Win your first {C:attention}ticket",
                    "and get {X:mult,C:white} X#1# {} multi",
                },
            },
            j_popcorn={
                name="And this popcorn",
                text={
                    "Q{C:mult}+#1#{} mol",
                    "{C:mult}- #2#{} mol per cycle",
                },
            },
            j_raised_fist={
    ...
    misc={
        achievement_descriptions={
            _100000k="Who collected 100 million chips in one hand?",
            _1000k="Each block costs 1,000,000 tokens.",
            _10k="On the one hand - buy 10,000 tablets.",
            ante_up="It's up to you which one to choose 4",
            ante_upper="When will the 8th come?",
            astronomy="The maps of each planet are as follows:",
            big_hands="There are over 80 cards in the set.",
            card_discarder="Discard at least 2500 cards.",
            card_player="People who have played at least 2500 cards.",
            cartomancy="I will reveal all the Tarot cards below.",
            clairvoyance="Each spectrogram looks like this:",
            completionist="Explore all collections",
            completionist_plus="Win any card on Gold Bet difficulty.",
            completionist_plus_plus="Each clown will receive a gold sticker",
            extreme_couponer="View all coupons below",
            flushed="For example, someone played flash with 5 clowns.",
            heads_up="this is a victory",
            high_stakes="Complete the game on Gold Bet difficulty or higher.",
            legendary="He also discovered the legendary clown",
            low_stakes="Win at least one race on Red Stakes difficulty.",
            mid_stakes="Win a round on Black Stakes difficulty or higher.",
            nest_egg="Anyone with more than $400 since then",
            retrograde="Raise each arm about 10 levels.",
            roi="5 coupons are given to 4 people",
            royale="Who plays King Flash?",
            rule_bender="run to complete the task",
            rule_breaker="Complete all challenges",
            shattered="There is only one Break 2 Bottle ticket available.",
            speedrunner="Something like a 12-game winning streak.",
            tiny_hands="Please limit the number of cards to less than 20.",
            you_get_what_you_get="Learn how to beat the game without looking back",
            hidden_achievement = "Learn more by playing! how",
        },
        achievement_names={
            _100000k="Nearly 100 million",
            _1000k="Like a million",
            _10k="It's 10,000.",
            ante_up="This is a gamble! how",
            ante_upper="Sign in! How",
            astronomy="What is astronomy?",
            big_hands="This big hand",
            card_discarder="Also ignore the map",
            card_player="This card player looks like this",
            cartomancy="This is keratinization",
            clairvoyance="What is vision?",
            completionist="This is done as follows",
            completionist_plus="S end +",
            completionist_plus_plus="Because extra++",
            extreme_couponer="As extreme coupon",
            flushed="how to clean",
            heads_up="Search for favorites",
            high_stakes="Which type of high risk do you like best?",
            legendary="like a legend",
            low_stakes="low risk",
            mid_stakes="Winning amount",
            nest_egg="I like saving money",
            retrograde="Feels a little retro",
            roi="return on investment",
            royale="Because the king likes it",
            rule_bender="After point c.",
            rule_breaker="This is against the rules",
            shattered="It shocked me too",
            speedrunner="It is a fast runner",
            tiny_hands="Because little hands are full of love",
        ...
        challenge_names={
            c_blast_off_1="There are a lot of explosions",
            c_bram_poker_1="What about Bram Booker?",
            c_city_1="It seems to be about 15 minutes from the city.",
            c_cruelty_1="oh i love cruelty",
            c_double_nothing_1="Double or nothing?",
            c_five_card_1="It's like a five card lottery ticket.",
            c_fragile_1="equally vulnerable",
            c_golden_needle_1="'Cause gold is like a needle",
            c_inflation_1="this is inflation",
            c_jokerless_1="It's like the clown doesn't exist",
            c_knife_1="Because that's what happens when you use a knife.",
            c_luxury_1="Like a luxury tax",
            c_mad_world_1="What a crazy world it is",
            c_medusa_1="like a jellyfish",
            c_monolith_1="Like this rock",
            c_non_perishable_1="immortal",
            c_omelette_1="I love omelettes",
            c_rich_1="The rich get richer",
            c_typecast_1="Thanks to type conversion",
            c_xray_1="For example, X-ray vision",
        },
        collabs={
            Clubs={
                ["1"]="This is the standard",
                ["2"]="vampire resident",
                ["3"]="The fork is removed",
                ["4"]="Because he made a potion.",
                ["5"]="Looks like a battle shot",
                ["6"]="like vodka",
                ["7"]="dying like the dawn",
            },
            Diamonds={
                ["1"]="This is the standard",
                ["2"]="What does Diver Dave mean?",
                ["3"]="This is what Stardew Valley looks like",
                ["4"]="Log in as Jongon",
                ["5"]="1000x reset yes",
                ["6"]="Like Civilization 7",
                ["7"]="like rust",
            },
            Hearts={
                ["1"]="This is the standard",
                ["2"]="He is also among us",
                ["3"]="How about the union of Isaac?",
                ["4"]="This is because I'm a Ramuk fan.",
                ["5"]="Just like original sin 2",
                ["6"]="This role is also very important",
                ["7"]="Posnak liked this one",
            },
            Spades={
                ["1"]="This is the standard",
                ["2"]="What kind of processor is it?",
                ["3"]="Because of Cyberpunk 2077",
                ["4"]="he is a knight",
                ["5"]="do not starve",
                ["6"]="Like Assassin's Creed",
                ["7"]="They line up to assassinate the prince",
            },
        },
        dictionary={
            ["$"]="$", --this WAS changed to "Like a dollar" at first but it was unplayable so i undid that
            b_FAQ="People ask a lot of questions like that, so",
            b_and_use="Use iron and how",
            b_back="For example return value",
            b_blinds="and curtains",
            b_booster_packs="People who like to give",
            b_buy="People who bought approx.",
            b_cash_out="Cash is also accepted",
            b_challenges="These issues include:",
            b_collection="also in the group",
            b_collection_cap="as a group",
            b_continue="Continue in line",
            b_copy="I like this version",
            b_copy_seed="Copy the seed like this",
            b_create_profile="This will create a configuration file named",
            b_credits="it's important",
            b_current_profile="Like your current profile",
            b_customize_deck="customize your deck",
            b_deck="This deck is very similar",
            b_decks="you are fine",
            b_delete_profile="This will delete the configuration file",
            b_discard="Leave like",
            b_editions="cost",
            b_endless="Like an endless article",
            b_enhanced_cards="What about premium cards?",
            b_full_deck="this whole area",
            b_high_contrast_cards="High Contrast Map",
            b_how_to_play="How to play How to play",
            b_imagery="like this photo",
            b_jokers="these clowns",
            b_load_profile="Load this configuration file as follows:",
            b_main_menu="Its main menu",
            b_music="like music",
            b_new_challenge="We are starting a new challenge",
            b_new_run="Such a new range",
            b_next="Because the next step",
            b_next_round_1="As in the",
            b_next_round_2="next round",
            b_open="Open approx",
            b_options="it's a choice",
            b_options_cap="this opportunity",
            b_planet_cards="What does a planetary map look like?",
            b_play_cap="He is playing",
            b_play_hand="This is also a play",
            b_playbalatro="Visit playbalatro.com.",
            b_poker_hands="What kind of person is a poker player?",
            b_quit_cap="Stay as is",
            b_redeem="What and how to get it",
            b_reduced_motion="Traffic flow has also decreased",
            b_remaining="That's it",
            b_reroll_boss="Recycling is like a cartridge",
            b_reset_profile="Reset profile",
            b_restrictions="What are the restrictions?",
            b_retry="I will try again",
            b_rules="there are rules",
            b_run_info_1="Click here for",
            b_run_info_2="shipping details",
            b_seals="Like a poster",
            b_seed="Because it is like a seed",
            b_select="This is a choice",
            b_sell="Almost sold out",
            b_set_CRT="cathode ray lamp",
            b_set_CRT_bloom="What does a CRT's aura look like?",
            b_set_apply="Starting soon",
            b_set_audio="sounds similar",
            b_set_crash_reports="as an urgent message",
            b_set_game="this game",
            b_set_game_vol="The scope of the competition",
            b_set_gamespeed="This is the speed of the game",
            b_set_graphics="like a chart",
            b_set_master_vol="Use this as your home folder",
            b_set_monitor="Appears as signals",
            b_set_music_vol="The volume of this music",
            b_set_pixel_smoothing="Like pixel antialiasing",
            b_set_play_discard_pos="The power button is in a similar position.",
            b_set_rumble="Console zipper",
            b_set_screenshake="This is screen vibration",
            b_set_shadows="What does the shadow look like?",
            b_set_vibration="such as vibration",
            b_set_video="I love this video",
            b_set_windowmode="I love this window",
            b_settings="Roughly defined as follows",
            b_skip="It will look like this",
            b_skip_blind="Act blindly",
            b_skip_reward="This also means losing your bonus.",
            b_sort_hand="The sequence of manual operations is as follows:",
            b_sounds="It seems that",
            b_spectral_cards="Spectrogram available",
            b_stake="Because I like nails",
            b_start_new_run="His new name",
            b_stat_consumables="Reference materials such as",
            b_stat_jokers="This is what this clown looks like",
            b_stat_planets="images of planets",
            b_stat_spectrals="spectrum",
            b_stat_tarots="Like tarot cards",
            b_stat_vouchers="These coupons",
            b_stats="Because I like statistics",
            b_tags="It's queued",
            b_tarot_cards="like a tarot card",
            b_unlock_all="open all",
            b_use="used as",
            b_vouchers="It's a choice",
            b_wishlist="This wishlist is now available on Steam.",
            k_aces="Ace loves her",
            k_achievement="It's such an achievement",
            k_achievements_disabled="The achievement has been removed.",
            k_active="Because I take the initiative to love you",
            k_active_ex="He is very active! how",
            k_again_ex="Here I am again! He loves",
            k_all_hands="like all hands",
            k_also_applied="This is done as follows",
            k_ante="The ants moved",
            k_ante_cap="female",
            k_arcana_pack="This secret group",
            k_balanced="It is also very balanced",
            k_banned_cards="Same as card blocking",
            k_banned_tags="What signs are prohibited?",
            k_base_cap="a base",
            k_base_cards="These main cards are as follows:",
            k_best_hand="as the best hand",
            k_booster="this is an amplifier",
            k_buffoon_pack="This clown bag",
            k_cap_consumables="As auxiliary material",
            k_card_stats="something like a status card",
            k_celestial_pack="It is a celestial body",
            k_challenge_mode="This is a test case",
            k_challenges="the question is how to do it",
            k_choose="How to choose?",
            k_collection="This group is approximately",
            k_common="in general",
            k_compatible="Which is correct?",
            k_copied_ex="I copied this! how",
            k_custom_rules="What about personal rules?",
            k_daily_run="This is what a daily run looks like",
            k_debuffed="it's autumn",
            k_deck="It's like a deck.",
            k_deck_stake_wins="This deck wins",
            k_defeated_by="who loses",
            k_demo_version_ex="This is a trial version! He loves",
            k_disabled_ex="Powerless! how",
            k_drank_ex="I'm drunk! how",
            k_duplicated_ex="cloning! like",
            k_dwarf_planet="Like this dwarf planet",
            k_eaten_ex="I ate it! how",
            k_edition="This version",
            k_effective="expiration date",
            k_empty_caps="It's empty",
            k_enter_name="Please enter the word in the line",
            k_enter_seed="Because the torrent contains:",
            k_enter_text="Please enter the name text",
            k_eroded_ex="Destroyed! How",
            k_extinct_ex="extinct! how",
            k_face_cards="I love these cards",
            k_game_modifiers="The changes to the game are as follows.",
            k_gold="Is this gold",
            k_high_score_ex="This is a very high indicator! How",
            k_hud_discards="Estimated number of employees",
            k_hud_hands="This hand",
            k_incompatible="But it doesn't work",
            k_joker="such a clown",
            k_joker_stickers="Looks like a clown poster",
            k_jokers_cap="Because he loves clowns",
            k_legendary="legendary",
            k_level_prefix="this level. how",
            k_level_up_ex="This is already the highest level! how",
            k_locked="Forbidden",
            k_lower_score="here is the result",
            k_lvl="this level. how",
            k_melted_ex="It melted! What he likes",
            k_money="This is what money looks like",
            k_mult="This is what comics look like",
            k_no_other_jokers="No more clowns! like",
            k_no_reward="As if there is no compensation",
            k_no_room_ex="No room left! like",
            k_no_space_ex="There are no gaps! like",
            k_none="Because there is no one to love",
            k_nope_ex="It's as if there isn't one!",
            k_not_allowed_ex="This is forbidden! like",
            k_not_discovered="Not published",
            k_numbered_cards="this is your card number",
            k_or="this and this",
            k_other="It's different",
            k_page="Like this page",
            k_planet="And this star",
            k_planet_q="is it a star how",
            k_playing_as="How to play",
            k_plus_joker="This clown likes +1",
            k_plus_planet="This is +1 star",
            k_plus_spectral="+1 It's a spectrum",
            k_plus_stone="+1 stone",
            k_plus_tarot="+1 like a tarot card",
            k_poker_hand="This is what this poker hand looks like",
            k_profile="Same profile",
            k_progress="This is progress",
            k_rank="Estimated to be approximate.",
            k_rare="rare",
            k_redeemed_ex="Please restore! The one he loves",
            k_reroll="This process",
            k_reset="reset it",
            k_reward="as a reward",
            k_round="The same goes for this trip.",
            k_safe_ex="This is a must! how",
            k_saved_ex="Please save! what he likes",
            k_seed="I love seeds",
            k_seeded_run="This workbook works like this",
            k_skipped_cap="How did it happen?",
            k_spectral="like a spectrum",
            k_spectral_pack="Such a spectral range.",
            k_stake="capital",
            k_stake_level="This price level is similar",
            k_standard_pack="This is the standard package",
            k_suit="○ For example, clothes.",
            k_swapped_ex="They have changed! The one he loves",
            k_tarot="those are tarot cards",
            k_trophies_disabled="Offer no longer valid",
            k_trophy="This is what the cup looks like",
            k_uncommon="Because, for example, it rarely happens.",
            k_undisovered="Not published",
            k_unknown="What? ? ? ? ? How",
            k_unlocked_ex="No lock! How",
            k_upgrade_ex="This is an update! like",
            k_val_up="This value is greater! how",
            k_view="what it looks like",
            k_voucher="Just like a coupon",
            k_vouchers_cap="What is a coupon?",
            k_wins="Get likes",
            ...
            ph_1_level="For example, level 1 and above.",
            ph_4_7_of_clubs="four 7 clubs",
            ph_alert_debuff_confirm="Press 'Play' again to confirm", --unused so idc
            ph_all_poker_hand="All poker hands",
            ph_blind_reward="How to get this prize: ",
            ph_blind_score_at_least="At least this rating",
            ph_boss_disabled="My boss is down! like",
            ph_choose_blind_1="Where to choose",
            ph_choose_blind_2="your next curtain",
            ph_click_confirm="Select again to confirm", --unchanged lmao
            ph_deck_preview_effective="Valid amounts for promotions, blinds and card upgrades are as follows:",
            ph_deck_preview_stones="stone",
            ph_defeat_the_boss="How to defeat the blind boss",
            ph_defeat_this_blind_1="Blind him and we",
            ph_defeat_this_blind_2="will understand how",
            ph_demo_thanks_1="Thanks for playing the",--demo
            ph_demo_thanks_2="BALATRO DEMO",--demo
            ph_display_stickers="Show execution speed tags",
            ph_game_over="This game is over",
            ph_improve_run="Improve your running! like",
            ph_most_played="Oldest (team with the most appearances).",
            ph_mr_bones="Good luck Mr Bones",
            ph_no_boss_active="Inactive",
            ph_no_vouchers="These emails cannot be used to obtain coupons.",
            ph_score_at_least="please at least call",
            ph_score_cards_discarded="The card has been removed",
            ph_score_cards_played="These are the cards you play",
            ph_score_cards_purchased="Got stuck",
            ph_score_furthest_ante="this is an antenna",
            ph_score_furthest_round="it's your turn",
            ph_score_hand="It's like the best hand",
            ph_score_new_collection="this is a new discovery",
            ph_score_poker_hand="Who would clap more?",
            ph_score_times_rerolled="The Times returns to work",
            ph_select_challenge="Please select a task",
            ph_sneak_peek="look here",
            ph_stat_consumable="How many times has this card been used?",
            ph_stat_joker="Typical trips using this card",
            ph_stat_voucher="Approximately how many times should I use this coupon?",
            ph_unscored_hand="He doesn't score with his hands",
            ph_up_ante_1="he picks up",
            ph_up_ante_2="Remove all toxins",
            ph_up_ante_3="renew the curtains",
            ph_vouchers_redeemed="How to redeem a coupon for this trip:",
            ph_you_win="I won! how",
            ph_you_win_demo="YOU WIN THE DEMO!", --demo so idc
            b_mods = 'Since the Ministry of Defense',
            b_mods_cap = 'Because it\'s a mod',
            b_modded_version = 'This is the hard version! as',
            b_steamodded = 'As in steam mode.',
            b_open_mods_dir = 'Open the mods folder like this',
            b_no_mods = 'Device not recognized...',
            b_mod_list = 'as a list of active mods',
            b_mod_loader = 'I like to download this mod',
            b_developed_by = 'Made by Ace ',
            b_rewrite_by = 'What is this address? ',
            b_github_project = 'As a project on GitHub',
            b_github_bugs_1 = 'You can report bugs and',
            b_github_bugs_2 = 'contribute. He loves',
            b_disable_mod_badges = 'Turn off the edit icon',
            b_author = 'Does the author write well?',
            b_authors = 'The author really likes it',
            b_unknown = 'not yet clear',
            b_lovely_mod = 'Yes (beautiful and elegant) ',
            b_by = 'This article was written by: How ',
            b_priority = 'Priority: How ',
			b_config = "Its composition",
			b_additions = 'moreover',
      		b_stickers = 'And those stickers',
			b_achievements = "What is the result",
      		b_applies_stakes_1 = 'Who do they belong to? ',
			b_applies_stakes_2 = '',
			b_graphics_mipmap_level = "This is a mip layer",
			b_browse = 'connection',
			b_search_prompt = 'He is looking for changes, for example.',
			b_search_button = 'Searching in progress',
            b_seeded_unlocks = 'Open like a seed',
            b_seeded_unlocks_info = 'You can open and find the seeds.',
            ml_achievement_settings = {
                'also disabled',
                'How is it activated?',
                'Bypass the limitations'
            },
            b_deckskins_lc = 'For example, low contrast colors.',
            b_deckskins_hc = 'For example, high contrast colors',
            b_deckskins_def = 'As a standard color',
            b_limit = 'Until then ',
            ...
            run_select_locked_stake = "Forbidden",
            run_select_locked_stake_message = "This team had such a win ",
            run_select_locked_stake_and = " this and so on. ",
            run_select_nothing = "there is nothing",
            run_select_selected = "Please select a waiting list",
            run_select_quick_start = "Quick start",
            run_select_play = "What a role",
            run_setup_enable_seed = "Allow it to broadcast",
            run_select_deck_choice = "Select by floor order",
        ...
        high_scores={
            ...
            collection="This is the group",
            current_streak="",
            furthest_ante="maximum bet",
            furthest_round="Like the best tour",
            hand="It's like the best hand",
            most_money="That's a lot of money",
            poker_hand="As the most played hand",
            win_streak="This is the best winning streak",
        },
        labels={
            blue_seal="This blue sticker",
            common="in general",
            eternal="like forever",
            foil="Immediately",
            gold_seal="This is a golden seal",
            ...
            planet="And this star",
            pluto_planet="Like this dwarf planet",
            polychrome="How about colorful?",
            purple_seal="Same as purple brand",
            rare="rare",
            red_seal="like a red seal",
            rental="It's like rent.",
            tarot="those are tarot cards",
            uncommon="Because, for example, it rarely happens.",
            voucher="Just like a coupon",
        },
        poker_hand_descriptions={
            ["Five of a Kind"]={
                "5 cards must have the same value",
            },
            Flush={
                "5 cards identical to Q",
            },
            ["Flush Five"]={
                "5 cards of the same value and format",
            },
            ["Flush House"]={
                "Any pair of three cards of the",
                "same suit, all of the same suit.",
            },
            ["Four of a Kind"]={
                "Question: There are 4 cards of the same value.",
                "You can also play different cards without scoring points.",
            },
            ["Full House"]={
                "What about triplets and twins?",
            },
            ["High Card"]={
                "If your hand is not one of the above, only",
                "the highest ranked card wins.",
            },
            Pair={
                "The same result was seen with the Q2 card.",
                "You can play up to 3 other undisclosed cards.",
            },
            ["Royal Flush"]={
                "5 cards in a row (all of the same suit).",
            },
            Straight={
                "If you arrange these five cards (in order), you get:",
            },
            ["Straight Flush"]={
                "5 cards in a row (all of the same suit).",
            },
            ["Three of a Kind"]={
                "3 cards of the same rank are required.",
                "You can play with the other two cards.",
            },
            ["Two Pair"]={
                "You can play two sets of cards with different",
                "values, but the other hand doesn't matter.",
            },
        },
        poker_hands={
            ["Five of a Kind"]="These five people are very similar",
            Flush="like a flash",
            ["Flush Five"]="flash 5",
            ["Flush House"]="Like a bright house",
            ["Four of a Kind"]="That is true",
            ["Full House"]="The whole house looks like this",
            ["High Card"]="This is the top card",
            Pair="The working time of this shoe is approx.",
            ["Royal Flush"]="The king is like a blush",
            Straight="keep straight",
            ["Straight Flush"]="as if blushing",
            ["Three of a Kind"]="These three are similar",
        ...
        ranks={
            ["10"]="This has 10 likes",
            ["2"]="Then there were 2 likes",
            ["3"]="That's 3 likes",
            ["4"]="about 4",
            ["5"]="looks like 5",
            ...
            ["8"]="In part 8",
            ["9"]="in part 9",
            Ace="It's like a trump card",
            Jack="like this guy",
            King="This is the king",
            Queen="And this is the queen",
        },
        suits_plural={
            Clubs="Club favorite",
            Diamonds="Like this diamond",
            Hearts="This heart looks like",
            Spades="It's like drilling",
        },
        suits_singular={
            Clubs="This club also has it",
            Diamonds="like this diamond",
            Hearts="Such a heart",
            Spades="This shovel",
        },
        ...
        v_dictionary={
            a_chips="It's about +#1#",
            a_chips_minus="equal to #1#",
            a_hands="+#1# hands",
            a_handsize="+#1# hand size yes",
            a_handsize_minus="-#1# types of hands",
            a_mult="+#1# pairs",
            a_mult_minus="-Multiply by #1#",
            a_remaining="#1# left",
            a_sold_tally="On sale no earlier than #1#/#2#.",
            a_xmult="Same as X#1# Multi",
            a_xmult_minus="Why do I love the X#1# Multi?",
            ante_x_voucher="ANTE #1# coupon like",
            challenges_completed="Mission completed on #1#/#2#",
            completed="#1#.#2#",
            deck_preview_wheel_plural="Since #1# cards are drawn face down, the number may be small.",
            deck_preview_wheel_singular="Since #1# card is drawn face down, the number may be small.",
            interest="#1#% match starting at $#2# (up to $#3#)",
            loyalty_active="positive! how",
            loyalty_inactive="Only #1# left",
