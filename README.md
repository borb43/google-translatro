# Google Translatro
This mod adds a new "Google Translated" language option, in which **every** string in the game is badly google translated.
...
and all seals and editions have the labels under the cards they are on be the same as their translated names